...
function getOperatorDefs() {
  return {
    ...
    recon: {
      ...
      roleZh: '\u4fa6\u67e5\u4f4d',
      roleEn: 'Recon',
      passiveZh: '\u5b9a\u4f4d\uff1a\u4fa6\u67e5\u4f4d\uff08\u5973\uff09\u3002\u88ab\u52a8\uff1a\u9ad8\u901f\u79fb\u52a8\uff0c\u5e76\u5927\u5e45\u964d\u4f4e\u654c\u4eba\u63d0\u524d\u53d1\u73b0\u5979\u7684\u8ddd\u79bb\u3002',
      passiveEn: 'Role: Recon (Female). Passive: high mobility with greatly reduced enemy detection.',
      skillNameZh: '\u5168\u57df\u5e7d\u7075\u626b\u63cf',
      skillNameEn: 'Global Ghost Scan',
      skillTextZh: '\u5168\u56fe\u626b\u63cf 30 \u79d2\uff0c\u6301\u7eed\u900f\u89c6\u5b58\u6d3b\u654c\u4eba\u5e76\u663e\u793a\u5175\u79cd\uff1b\u671f\u95f4\u5f00\u706b\u4e0d\u4f1a\u56e0\u67aa\u58f0\u5438\u5f15\u654c\u4eba\uff0c\u79fb\u901f\u63d0\u5347\u81f3 1.4 \u500d\uff0c\u88ab 3 \u4eba\u4ee5\u4e0a\u56f4\u653b\u65f6\u63d0\u5347\u5230 1.8 \u500d\u3002',
      skillTextEn: 'Scans the entire map for 30s, continuously revealing living enemies and their class. Gunshots do not attract enemies by sound, speed rises to 1.4x, and reaches 1.8x when pressured by 3+ enemies.',
      itemNameZh: '\u514b\u83b1\u5c14\u5e7d\u7075\u626b\u63cf\u5668',
      itemNameEn: 'Claire Ghost Scanner',
      moveMult: 1.12,
      spreadMult: 0.9,
      reloadMult: 0.9,
      detectMult: 0.55,
...
function useOperatorAbility() {
  ...
  if (operator.id === 'assault') {
    ...
    notify(
      L(`全域幽灵扫描已启动，${operator.abilityDuration} 秒内持续揭示全图 ${revealedCount} 名敌人与兵种。`, `Global Ghost Scan activated. ${revealedCount} enemies and classes are revealed across the map for ${operator.abilityDuration}s.`),
      'success',
    );
  }
